...
signal archetype_selected(slot: int, archetype_id: String, player_name: String)
signal cancelled

enum SelectionPhase { ARCHETYPE, NAME, SLOT, CONFIRM_OVERWRITE }
...
func _show_name_entry() -> void:
	...
	hint_label.text = "Type your name | Enter: Confirm | Q: Back"
...
func _handle_name_input(event: InputEvent) -> void:
	# Let LineEdit handle text input, but intercept Enter and Q
...
func _finalize_selection() -> void:
	...
	archetype_selected.emit(_selected_slot_index, archetype_id, _player_name)
